import{s as i,g as b,R as I,r as p,j as e,L as te,e as Q,b as M,h as ie,Q as N,t as ne,v as re}from"./index-551fc0ab.js";import{s as T}from"./sprite-078679a8.js";import{e as O}from"./exercisesSelectors-80adadd9.js";import{L as oe}from"./Loader-d54ad5c5.js";import{L as se}from"./Loading-6a242952.js";import"./Hourglass-5c8bdd47.js";const ae=i.div`
    display: flex;
...
`,Ke=({data:n,onClose:t})=>{const s=n;return e.jsx(Oe,{children:e.jsxs(Ge,{children:[e.jsx(Y,{type:"button",onClick:t,children:e.jsx(J,{children:e.jsx("use",{href:`${T}#icon-x`})})}),e.jsxs(Ne,{children:[e.jsx(qe,{src:Me,alt:"exercise"}),e.jsx(Ue,{children:"Well done"}),e.jsxs(P,{children:["Your time: ",e.jsx(K,{children:s.time})]}),e.jsxs(P,{children:["Burned calories: ",e.jsx(K,{children:s.burnedCalories})]})]}),e.jsx(_e,{onClick:t,children:"Next exercise"}),e.jsx(te,{to:"/diary",children:e.jsxs(P,{children:["To the diary",e.jsx(He,{children:e.jsx("use",{href:T+"#icon-start"})})]})})]})})},Qe=({data:n,onClose:t})=>{const s=n,[r,a]=p.useState(!1),[c,l]=p.useState(180),[h,u]=p.useState(0),[g,d]=p.useState(!1),[o,x]=p.useState(),[m,j]=p.useState(!0),C=Q(),v=s.burnedCalories,y=M(O.getIsLoading),f=()=>{a(S=>!S)},w=()=>{j(!1),d(!0),x(n)},k=async S=>{S.preventDefault(),r&&a(!1);const Z=s.time*60-c+1,G={exerciseId:s._id,burnedCalories:h,time:Z};try{C(ie.postDiaryExercise(G)),N.success("Success!")}catch(ee){N.error(ee.message)}j(!1),d(!0),x(G)},{name:E,target:$,bodyPart:z}=s,B=S=>S.slice(0,10);return e.jsxs(be,{children:[g&&!m&&e.jsx(Ke,{onClose:t,data:o,setModalOpenSecond:d}),m&&e.jsxs(we,{onSubmit:k,children:[y&&e.jsx(oe,{}),e.jsx(Y,{type:"button",onClick:t,children:e.jsx(J,{children:e.jsx("use",{href:`${T}#icon-x`})})}),e.jsxs(je,{children:[e.jsx(ye,{children:e.jsx(ke,{src:s.gifUrl,alt:"Gif-Exercises"})}),e.jsx(Pe,{setDinamicBurnCal:u,dinamicBurnCal:h,burnedCalories:v,toggleTimer:f,timerIsRunning:r,setRemainingTime:l,setTimerIsRunning:a,remainingTime:c,handleSubmit:k,exerciseComplete:w})]}),e.jsxs(ve,{children:[e.jsxs(q,{children:[" ",e.jsxs(L,{children:[e.jsx(R,{children:"Name"}),e.jsx(D,{children:B(E)})]}),e.jsxs(L,{children:[e.jsx(R,{children:"Target"}),e.jsx(D,{children:B($)})]})]}),e.jsxs(q,{children:[e.jsxs(L,{children:[e.jsx(R,{children:"Target"}),e.jsx(D,{children:B($)})]}),e.jsxs(L,{children:[e.jsx(R,{children:"Body Parts"}),e.jsx(D,{children:B(z)})]})]})]}),e.jsx(Ce,{type:"submit",disabled:!h,children:"Add to diary"})]})]})},tt=()=>{const{category:n}=ne(),t=Q(),s=M(O.getExercisesData),r=M(O.getIsLoading),[a,c]=p.useState(""),[l,h]=p.useState(!1);p.useEffect(()=>{t(re.getExercises())},[t]);const u=s.filter(o=>o.bodyPart===n||o.target===n||o.equipment===n),g=o=>{const x=o.currentTarget.id,m=s.filter(j=>j._id===x);c(m),h(!0)},d=()=>{h(!1)};return p.useEffect(()=>{function o(x){x.key==="Escape"&&d()}return l&&window.addEventListener("keydown",o),()=>{window.removeEventListener("keydown",o)}},[l]),e.jsxs(ae,{children:[r&&e.jsx(se,{}),!r&&u&&u.map(o=>e.jsxs(le,{children:[e.jsx(he,{children:"WORKOUT"}),e.jsx(ce,{id:o._id,type:"button",onClick:g,children:e.jsxs(de,{children:[e.jsx(pe,{children:"Start"}),e.jsx(xe,{children:e.jsx("use",{href:`${T}#icon-start`})})]})}),e.jsxs(ue,{children:[e.jsx(ge,{children:e.jsx("use",{href:`${T}#icon-running-exercises-page`})}),e.jsx(me,{children:o.name})]}),e.jsxs(fe,{children:[e.jsxs(W,{children:[e.jsx(A,{children:"Burned calories:"}),e.jsx(F,{children:o.burnedCalories})]}),e.jsxs(W,{children:[e.jsx(A,{children:"Body part:"}),e.jsx(F,{children:o.bodyPart})]}),e.jsxs(W,{children:[e.jsx(A,{children:"Target:"}),e.jsx(F,{children:o.target})]})]})]},o._id)),l&&e.jsx(Qe,{data:a[0],onClose:d})]})};export{tt as default};
