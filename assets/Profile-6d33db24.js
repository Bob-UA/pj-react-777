import{s as i,g as n,e as M,b as g,d as u,j as e,o as q,Q as I,r as T}from"./index-551fc0ab.js";import{u as Y,B as _}from"./Button-0814bd4d.js";import{S as G,t as Q,C as J}from"./DaySwitch.styled-7588e019.js";import{c as K,a as B,b as j,d as X}from"./index.esm-89a08871.js";import{C as O}from"./ContainerStyled-bb0b3bf9.js";import{s as h}from"./sprite-078679a8.js";import"./createClass-ee7846a7.js";const Z=i.form`
  padding-top: 18px;
...
`;i.input`
  ...
  letter-spacing: 0em;
  text-align: left;
`;const de=K().shape({name:B().required("Name is required"),height:j().min(150,"Height must be at least 150 cm").required("Height is required"),currentWeight:j().min(35,"Weight must be at least 35 kg").required("Current weight is required"),desiredWeight:j().min(35,"Weight must be at least 35 kg").required("Desired weight is required"),birthday:X().max(new Date(new Date().getFullYear()-18,new Date().getMonth(),new Date().getDate()),"Must be at least 18 years old").required("Birthday is required"),blood:j().oneOf([1,2,3,4],"Invalid blood type").required("Blood type is required"),sex:B().oneOf(["male","female"],"Invalid gender").required("Gender is required"),levelActivity:j().oneOf([1,2,3,4,5],"Invalid activity level").required("Activity level is required")}),le=i.div`
  ${O};
  display: flex;
  flex-direction: column;
  justify-content: center;
